...
|  --- | --- | --- | --- | --- | --- |
| `accountHolderName` | `string` | Required | Account holder name<br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `32` | getAccountHolderName(): string | setAccountHolderName(string accountHolderName): void |
| `accountNumber` | `string` | Required | Account number<br>**Constraints**: *Minimum Length*: `4`, *Maximum Length*: `19` | getAccountNumber(): string | setAccountNumber(string accountNumber): void |
...
| `accountType` | [`string (AccountType6Enum)`](../../doc/models/account-type-6-enum.md) | Required | Account type | getAccountType(): string | setAccountType(string accountType): void |
...
| `routingNumber` | `string` | Required | Required for ACH. The Routing Number for the bank account being used. | getRoutingNumber(): string | setRoutingNumber(string routingNumber): void |
